			...
			<table class="table base-table table-striped">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a class="btn btn-primary btn-sm" href="{{ URL::route('articles.edit', $article->id) }}">编辑</a>
							<a class="btn btn-danger btn-sm remove-record" href="javascript:void(0);" data-toggle="modal" data-url="{{ route('articles.destroy', $article) }}" data-id="{{ $article->id }}" data-target="#custom-width-modal">删除</a>
						</td>
					</tr>
					@endforeach
					@endif
