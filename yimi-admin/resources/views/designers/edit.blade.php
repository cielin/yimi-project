...
{{ Form::open(array('route' => array('designers.update', $designer), 'files' => true, 'role' => 'form')) }}
			...
			<div class="col-md-8">
				...
				<div class="post-title">
					<div class="form-group">
						<input name="name" type="text" class="form-control" placeholder="设计师姓名" value="{{ $designer->name }}">
					</div>
				</div>

				<!-- 编辑器 -->
				<div class="post-editor form-group">
					<textarea id="editor" name="description" class="form-control" rows="12">{{ $designer->description }}</textarea>
				</div>

				<!-- 产品图 -->
				<div class="card">
					<div class="card-header">设计师大图</div>
					<div class="card-body">
						<div class="pro-pic">
							<div class="row">
								<div class="col-md-3">
									<div class="thumbnail">
										...
										@else
										{{ Html::image('storage' . config('imgattrs.designer_avatar.thumbnail') . '/thumb_' . $designer->avatar, $designer->name) }}
										@endif
										<div class="caption clearfix">
											<p>
												...
												{{ Form::file('avatar', array('class'=>'thumb', 'style'=>'width: 0; height: 0; visibility: hidden;')) }}
											</p>
										</div>
									</div>
								</div>
