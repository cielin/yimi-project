...
{{ Form::open(array('route' => 'banners.store', 'files' => true, 'role' => 'form')) }}
<!-- Header Bar -->
			...
			<div class="col-md-8">
				...
				<div class="post-title">
					<div class="form-group">
						<input name="title" type="text" class="form-control" placeholder="Banner标题">
					</div>
					<div class="form-group input-group mb-3">
						...
						<select class="custom-select" id="type" name="type">
							<option value="0" selected>首页头图</option>
							<option value="1">首页二屏左大图</option>
							<option value="2">首页二屏右方图</option>
							<option value="3">首页二屏右长图</option>
						</select>
					</div>
					<div class="form-group">
						<input name="link" type="text" class="form-control" placeholder="图片链接">
					</div>
				</div>
